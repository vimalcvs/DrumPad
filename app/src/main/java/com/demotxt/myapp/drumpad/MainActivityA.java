...
public class MainActivityA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound1 = sp.load(getApplicationContext(),R.raw.waking_up_a_clap_01,1);
        sound2 = sp.load(getApplicationContext(),R.raw.waking_up_a_hat_01,1);
        sound3 = sp.load(getApplicationContext(),R.raw.waking_up_a_kick_01,1);
        sound4 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbirachord_01,1);
        sound5 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbirachord_02,1);
        sound6 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbirachord_03,1);
        sound7 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbiranote_01,1);
        sound8 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbiranote_02,1);
        sound9 = sp.load(getApplicationContext(),R.raw.waking_up_a_mbiranote_03,1);
        sound10 = sp.load(getApplicationContext(),R.raw.waking_up_a_vox_01,1);
